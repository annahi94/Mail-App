...
var ProductsComponent = /** @class */ (function () {
    ...
    ProductsComponent.prototype.onSelectedProduct = function (product) {
        this.selectedProduct = product;
        this.productService.getProduct(2)
            .subscribe(function (product) { return console.log(product); });
    };
    ...
    ProductsComponent.prototype.save = function (product) {
        this.productService.updateProdcut(product)
            .subscribe(function () { return console.log('Product saved!!'); });
    };
    ProductsComponent.prototype.add = function (name, price) {
        var _this = this;
        this.productService.addProduct({ name: name, price: price })
